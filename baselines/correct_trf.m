function [D_new] = correct_trf(D0, tol)
% function [D_new] = correct_trf(D0, tol)
%
% Correct a distance matrix by the Triangle Fixing (TRF) algorithm
%
% @param  D0      Initial distance matrix
% @param  tol     Tolerance for terminal
% @return D_new   Corrected matrix
%
% <Reference>
% Brickell, Justin, et al. "The metric nearness problem." SIAM Journal on 
% Matrix Analysis and Applications 30.1: 375-396, 2008.
